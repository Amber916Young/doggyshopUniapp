<script>
	...
	export default {
		...
		methods:{
			loadBasicCache(){
				var myApp = this
				myApp.globalData.customer =  uni.getStorageSync('customer') || {}
			}
		}
	}
</script>
...
.cart-bar .r .topay .noopen {
  ...
  color: #fff;
   ...
   .replycontent{
	...
	.color-1 {color: #ff5733;}
	.color-2 {color: #ffbd33;}
	.color-3 {color: #dbff33;}
	.color-4 {color: #75ff33;}
	.color-5 {color: #33ff57;}
	.color-6 {color: #33ffbd;}
	.color-1-1 {color: #ff5733;}
	.color-1-2 {color: #ef5c3d;}
	.color-1-3 {color: #df6146;}
	.color-1-4 {color: #cf6650;}
	.color-1-5 {color: #bf6b59;}
	.color-1-6 {color: #af7063;}
	.color-1-7 {color: #9f756c;}
	.color-1-8 {color: #8f7a76;}
